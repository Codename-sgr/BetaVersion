...
public class vehicle extends AppCompatActivity {
    ...
    public void post(View view)
    {
        ...
        VehicleAd vehicleAd= new VehicleAd(ad_id,user_id,model.getText().toString(),purchaseDate.getText().toString(),insuranceDate.getText().toString(),Integer.parseInt(milege.getText().toString()),description.getText().toString());
